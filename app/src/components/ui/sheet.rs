...
pub fn SheetTrigger(
    ...
    let ctx = use_context::<SheetContext>().expect("SheetTrigger must be inside a Sheet");
...
pub fn SheetClose(
    ...
    let ctx = use_context::<SheetContext>().expect("SheetClose must be inside a Sheet");
...
pub fn SheetContent(
    ...
    let ctx = use_context::<SheetContext>().expect("SheetContent must be inside a Sheet");
    ...
    view! {
        ...
        <div
            ...
            class=merged_class
            id=ctx.target_id
            data-direction=direction.as_ref().to_string()
            data-state="closed"
