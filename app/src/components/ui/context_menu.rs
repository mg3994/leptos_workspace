...
mod components {
    ...
    clx! {ContextMenuSubContent, ul, "context__menu_sub_content", "rounded-md border bg-card shadow-lg p-1 absolute inset-inline-start-full inset-block-start-[-4px] z-[100] min-w-[160px] opacity-0 invisible translate-x-[-8px] transition-all duration-200 ease-out pointer-events-none"}
...
pub fn ContextMenuAction(
    ...
    let _ctx = use_context::<ContextMenuContext>().expect("ContextMenuAction must be inside a ContextMenu");
...
pub fn ContextMenuTrigger(
    ...
    let ctx = use_context::<ContextMenuContext>().expect("ContextMenuTrigger must be inside a ContextMenu");
...
pub fn ContextMenuContent(
    ...
    let ctx = use_context::<ContextMenuContext>().expect("ContextMenuContent must be inside a ContextMenu");
